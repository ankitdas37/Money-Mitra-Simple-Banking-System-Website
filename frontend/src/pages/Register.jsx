    ...
    <div style={{ minHeight: '100vh', display: 'flex', fontFamily: 'Outfit, sans-serif', background: 'var(--bg-base)', overflowX: 'hidden' }}>
      ...
      <div className="register-right-panel">
        <div className="register-form-inner">
          ...
          {step === 0 && (
            <div>
              <h2 style={{ fontSize: 20, fontWeight: 800, margin: '0 0 20px' }}>👤 Identity & Photo</h2>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: 12, marginBottom: 14, alignItems: 'end' }}>
                ...
                {age !== null && (
                  <div style={{ background: age >= 18 ? 'rgba(0,229,160,0.1)' : 'rgba(255,87,87,0.1)', border: `1px solid ${age >= 18 ? 'rgba(0,229,160,0.3)' : 'rgba(255,87,87,0.3)'}`, borderRadius: 10, padding: '10px 16px', textAlign: 'center' }}>
            ...
            <div>
              ...
              {form.occupation === 'Other' && (
                <div style={{ marginBottom: 14 }}>
                  ...
                  <input style={inputS} placeholder="e.g. Musician, Artist..." value={otherOccupation} onChange={e => setOtherOccupation(e.target.value)} />
                </div>
              )}
          ...
          {step === 3 && (
            <div>
              ...
              <label style={{ display: 'flex', alignItems: 'flex-start', gap: 10, cursor: 'pointer', marginBottom: 16, padding: '12px 14px', background: termsAccepted ? 'rgba(0,229,160,0.07)' : 'rgba(255,255,255,0.03)', border: `1px solid ${termsAccepted ? 'rgba(0,229,160,0.35)' : 'rgba(255,255,255,0.1)'}`, borderRadius: 10, transition: 'all 0.2s' }}>
                <input type="checkbox" checked={termsAccepted} onChange={e => setTermsAccepted(e.target.checked)} style={{ width: 18, height: 18, accentColor: '#00E5A0', cursor: 'pointer', flexShrink: 0, marginTop: 1 }} />
