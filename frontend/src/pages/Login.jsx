  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', fontFamily: 'Outfit, sans-serif', background: 'var(--bg-base)', overflowX: 'hidden' }}>
      <style>{`
        ...
        .remember-check { accent-color: var(--primary); cursor:pointer; }
        .login-left-panel { flex: 0 0 42%; position: relative; overflow: hidden; display: flex; flex-direction: column; justify-content: flex-end; }
        .login-right-panel { flex: 1; display: flex; align-items: center; justify-content: center; padding: 40px 48px; position: relative; overflow-y: auto; }
        .login-form-inner { width: 100%; max-width: 400px; position: relative; }
        .login-mobile-header { display: none; }
        @media (max-width: 768px) {
          .login-left-panel { display: none !important; }
          .login-right-panel { padding: 0; align-items: flex-start; overflow-y: auto; min-height: 100vh; }
          .login-form-inner { max-width: 100%; padding: 20px 20px 40px; }
          .login-mobile-header { display: flex; align-items: center; gap: 10px; margin-bottom: 18px; }
        }
        @media (max-width: 480px) {
          .login-form-inner { padding: 16px 16px 40px; }
        }
      ...
      {/* ── Left: Anime Background Panel (desktop only) ── */}
      ...
      <div className="login-right-panel">
        ...
        <div className="login-form-inner">
          ...
          <div className="login-mobile-header">
            <img src="/logo.png" alt="Money Mitra" style={{ width: 38, height: 38, borderRadius: 10, objectFit: 'cover', border: '2px solid rgba(108,99,255,0.4)' }} />
            <div>
              <div style={{ fontSize: 17, fontWeight: 800 }}><span className="text-gradient">Money Mitra</span></div>
              <div style={{ fontSize: 11, color: 'var(--text-muted)' }}>Digital Banking Platform</div>
            </div>
          </div>
          ...
          <div style={{ marginBottom: 28 }}>
            ...
            <h1 style={{ fontSize: 'clamp(22px, 6vw, 28px)', fontWeight: 900, margin: '0 0 6px', lineHeight: 1.2 }}>Welcome Back 👋</h1>
            <p style={{ fontSize: 13, color: 'var(--text-muted)', margin: 0 }}>Sign in to access your digital bank vault</p>
          </div>

          {/* Form Card */}
          <div className="glass-card" style={{ padding: 'clamp(16px, 4vw, 28px)' }}>
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
              ...
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  <input
                    ...
                    required
                    style={{ paddingRight: 52, fontSize: 14, width: '100%' }}
                    autoComplete="current-password"
                  />
                  <button type="button" onClick={() => setShowPassword(!showPassword)} style={{
                    position: 'absolute', right: 14, top: '50%', transform: 'translateY(-50%)',
                    background: 'none', border: 'none', cursor: 'pointer', fontSize: 18,
                    color: 'var(--text-muted)', minWidth: 32, minHeight: 32,
              ...
              {/* Remember Me */}
              <label style={{ display: 'flex', alignItems: 'center', gap: 10, cursor: 'pointer', userSelect: 'none', minHeight: 36 }}>
                <input
                  type="checkbox"
              ...
              <button type="submit" className="btn-primary" disabled={loading} style={{ padding: '14px', fontSize: 15, fontWeight: 800, marginTop: 4, minHeight: 50, width: '100%' }}>
                {loading ? (
      ...
      {showForgot && (
        <div style={{
          ...
          <div style={{
            ...
            padding: 'clamp(20px, 5vw, 36px)', width: '100%', maxWidth: 420,
            ...
            {!forgotSent ? (
              <>
                ...
                <form onSubmit={handleForgotPassword} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                  ...
                  <div style={{ display: 'flex', gap: 10 }}>
                    ...
                    <button type="submit" className="btn-primary" style={{ flex: 2, minHeight: 48 }} disabled={forgotLoading}>
                      {forgotLoading ? (
                        <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
              ...
              <div style={{ textAlign: 'center', padding: '10px 0' }}>
                ...
                <button className="btn-primary" style={{ width: '100%', padding: '13px 0', minHeight: 50 }}
