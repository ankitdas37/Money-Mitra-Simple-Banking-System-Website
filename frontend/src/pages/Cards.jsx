    ...
    <div>
      ...
      {showCreate && (
        <div className="glass-card" style={{ padding: 24, marginBottom: 24 }}>
          ...
          <div className="grid-responsive-3" style={{ gap: 14, marginBottom: 18 }}>
            <div>
          ...
          return (
            <div key={card.id}>
              ...
              <div className="glass-card" style={{ padding: 20, marginTop: 14 }}>
                ...
                {/* Stats row */}
                <div className="grid-responsive-2" style={{ gap: 10, marginBottom: 16 }}>
                ...
                <div className="grid-responsive-3" style={{ gap: 8, marginBottom: 8 }}>
                ...
                {isRevealed && (
                  <div style={{ marginTop: 14, background: 'rgba(255,184,76,0.06)', border: '1px solid rgba(255,184,76,0.2)', borderRadius: 12, padding: '12px 16px' }}>
                    ...
                    <div style={{ display: 'flex', gap: 10, marginTop: 10 }}>
                      <button onClick={() => copyToClipboard(revealed.card_number.replace(/\s/g, '')).then(() => toast.success('Card number copied!'))}
